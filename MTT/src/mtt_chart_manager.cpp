...
void ChartsManager::onChangedYear(const QString& startInterval, const QString& endInterval)
{
    emit requestToSetChartData(m_selectedCoordinatesOnMap, startInterval, endInterval);
}
